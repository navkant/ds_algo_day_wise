...
# If the target value is not found and least number greater than equal to target is also not present, return the
# length of array (i.e. the position where target can be placed)
